...
public class TextRectTest extends TestCase {
	...
	final TextRect tr3 = new TextRect(1, 1, 1, 50, 26, 1);
	...
	public void testFind3() {
		...
		assertTrue(rects.get(0).equals(new TextRect(1, 1, 1, 50, 26, 1)));
		assertTrue(rects.get(1).equals(new TextRect(2, 1, 1, 50, 26, 1)));
	}

	public void testFind4() {
		List<TextRect> rects = tr3.find("FIRST[np]");
		assertTrue(rects.size() == 1);
		assertTrue(rects.get(0).equals(new TextRect(2, 1, 1, 50, 26, 1)));
	}
	...
	public void testFind6() {
		...
		assertTrue(rects.get(0).equals(new TextRect(1, 1, 1, 50, 26, 1)));
		assertTrue(rects.get(1).equals(new TextRect(2, 1, 1, 50, 26, 1)));
		assertTrue(rects.get(2).equals(new TextRect(3, 1, 1, 50, 26, 1)));
	}

	public void testFind7() {
		List<TextRect> rects = tr3.find("[tr1,1,50,24]");
		assertTrue(rects.size() == 1);
		assertTrue(rects.get(0).equals(new TextRect(1, 1, 1, 50, 24, 1)));
	}
	...
	public void testFind9() {
		...
		assertTrue(rects.size() == 2);
		assertTrue(rects.get(0).equals(new TextRect(1, 1, 1, 50, 24, 1)));
		assertTrue(rects.get(1).equals(new TextRect(1, 1, 25, 50, 24, 1)));
	}
	...
	public void testFind10() {
		...
		assertTrue(rects.size() == 2);
		assertTrue(rects.get(0).equals(new TextRect(1, 1, 1, 50, 24, 1)));
		assertTrue(rects.get(1).equals(new TextRect(1, 1, 25, 50, 24, 2)));
	}
	...
	public void testFind11() {
		...
		assertTrue(rects.get(0).equals(new TextRect(1, 1, 1, 50, 24, 1)));
		assertTrue(rects.get(1).equals(new TextRect(1, 1, 25, 50, 24, 2)));
		assertTrue(rects.get(2).equals(new TextRect(2, 1, 1, 50, 26, 3)));
	}
